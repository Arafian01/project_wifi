    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <!-- buatkan icon lonceng yang terdapat bulat di sebelah kanan atas kecil yang di dalamnya angka -->
                @php
                    $notifCount = App\Models\Notifikasi::count();
                @endphp
                ...
                <a href="{{ route('notifikasi.index') }}" class="relative">
                    ...
                    <svg class="w-6 h-6 text-gray-600 hover:text-gray-800" fill="none" stroke="currentColor"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14V10a6 6 0 00-12 0v4c0 .386-.146.74-.405 1.005L4 17h5m6 0a3 3 0 01-6 0">
                        </path>
                    </svg>
