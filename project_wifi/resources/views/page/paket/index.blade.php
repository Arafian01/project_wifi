                    ...
                    <div class="w-full bg-gray-100 p-4 rounded-xl">
                        ...
                        <form action="{{ route('paket.store') }}" method="post">
                            ...
                            <div class="mb-5">
                                ...
                                <textarea name="deskripsi" type="text" id="deskripsi"
                                        ...
                                        <tr
                                            ...
                                            <td class="px-6 py-4">
                                                <button type="button" data-id="{{ $k->id }}"
                                                    data-modal-target="sourceModal" data-nama_paket="{{ $k->nama_paket }}"
                                                ...
                                                <button
                                                    onclick="return supplierDelete('{{ $k->id }}','{{ $k->nama_paket }}')"
                ...
                <form method="POST" id="formSourceModal">
                    ...
                    <div class="flex flex-col  p-4 space-y-6">
                        ...
                        <div class="">
                            ...
                            <textarea type="text" id="deskripsi_edit" name="deskripsi"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
...
<script>
    ...
    const supplierDelete = async (id, nama_paket) => {
